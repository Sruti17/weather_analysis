...
redshift_output=glueContext.write_dynamic_frame.from_options(
    ...
    connection_option={
        ...
        "preactions":"DROP TABLE IF EXISTS public.weather_data; CREATE TABLE IF NOT EXIST public.weather_data (dt VARCHAR, weather VARCHAR,visibility VARCHAR,temp VARCHAR,feels_like VARCHAR, min_temp VARCHAR,max_temp VARCHAR,pressure VARCHAR,sea_level VARCHAR, ground_level VARCHAR,humidity VARCHAR,wind VARCHAR);",
    },
